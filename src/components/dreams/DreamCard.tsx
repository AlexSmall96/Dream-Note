...
export default function DreamCard () {
    ...
    return (
        <div className="font-caveat relative mb-8 pt-8 px-6 pb-20 bg-[url('/images/paper.jpg')] bg-cover bg-center rounded-lg shadow-lg border border-purple-100 w-full max-w-3xl h-110">
            ...
            <p className="text-md text-xl text-gray-700 leading-relaxed font-light min-h-[150px] italic overflow-y-auto scrollbar-custom-gray max-h-60 mb-4 pb-4 pr-5 text-justify">
                {dream.description}
            </p>
            <DreamThemeList />
            <StickyNote  />
