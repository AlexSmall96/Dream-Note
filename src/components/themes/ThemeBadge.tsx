...
export function ThemeBadge({
    ...
    return(
        <span id="badge-dismiss-brand w-20 truncate " 
            className="inline-flex items-center bg-brand-softer bg-gray-300 px-2 py-1 mb-0.5 mr-1 border border-brand-subtle text-fg-brand-strong text-xs font-medium rounded gap-1">
            <span className='w-full max-w-[100px] group truncate'>{currentTheme}</span>
