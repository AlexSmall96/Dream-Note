...
export function ThemeBadge({
    ...
    return(
        <span id="badge-dismiss-brand" 
            className="inline-flex items-center bg-brand-softer bg-gray-300 px-2 py-1 mr-1 border border-brand-subtle text-fg-brand-strong text-xs font-medium rounded gap-1">
            {currentTheme}
